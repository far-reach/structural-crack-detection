...
![Pipeline Overview](results/Fig%201%20Automated%20structural%20damage%20detection%20pipeline.png)
...
![Training Curves](results/training_curves_multiclass.png)

![Confusion Matrix](results/confusion_matrix_multiclass.png)
...
![3-class Segmentation Results](results/segmentation_results.png)

![4-class Segmentation Results](results/segmentation_4class_results.png)
...
![UAV Damage Map](results/drone_damage_map.png)
